...
}public function dologin()
{
    ...
    $pswd = $this-> db->get_where('users',['email' =>$user])->row_array();
    if($user){ 
        ...
        $this->session->set_flashdata('message','<div class="alert alert-danger" role="alert> </b>Error :</b>Tidak Terdaftar. </div>');
        redirect('/'); 
    }}
