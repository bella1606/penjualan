                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <div>
                                        ...
                                        <a href=".base_url('Barang/delete/'.$barang->id)." class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus data kategori ini?\");'><i class='fas fa-trash'></i> Hapus</a>
                                    </div>
                                </td>
                            </tr>";
                            $no++;
